...
void led_toggle() {
    switch (currentMode) {
        case 0:
            ...
            setLEDToRed_Matrix2(currentRow, currentCol);
            break;
        case 1:
        ...
        case 2:
            ...
            setLEDToGreen_Matrix2(currentRow, currentCol);
            break;
    }
...
void slave(void *pvParameters) {
    ...
    while (Nrf24_setRADDR(&dev, (uint8_t *)"3RECV") != 0);
    while (Nrf24_setTADDR(&dev, (uint8_t *)"3RECV") != 0);
